...
const FALLBACK_HTML_URL = 'https://as9697347.github.io/img/offline.html';
...
workbox.routing.registerRoute(
    new RegExp('https://anhhacker.blogspot.com/new-images/(.*)'),
    new workbox.strategies.CacheFirst({
...
workbox.routing.registerRoute(
    new RegExp('https://(?:ajax.cloudflare|www.google-analytics|cdnjs.cloudflare|pagead2.googlesyndication).com/(.*)'),
...
workbox.routing.registerRoute(
    new RegExp('.(?:css|png|gif|jpg|svg|woff|woff2|jpeg|ico|js)$'),
    new workbox.strategies.CacheFirst({
